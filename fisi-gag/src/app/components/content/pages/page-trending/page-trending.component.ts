...
@Component({
  selector: 'app-page-trending',
  templateUrl: './page-trending.component.html',
  styleUrls: ['./page-trending.component.scss']
})
export class PageTrendingComponent implements OnInit {
